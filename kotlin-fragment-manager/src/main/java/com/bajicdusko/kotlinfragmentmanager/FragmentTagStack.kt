...
class FragmentTagStack : Parcelable {
  ...
  companion object CREATOR : Creator<FragmentTagStack> {
    override fun createFromParcel(parcel: Parcel): FragmentTagStack {
      return FragmentTagStack(parcel)
    }

    override fun newArray(size: Int): Array<FragmentTagStack?> {
